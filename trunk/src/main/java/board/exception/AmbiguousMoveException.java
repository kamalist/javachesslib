...
/** Exception thrown when a given move is ambiguous.
 * For example, when two knights can move to the same square 
 * and we can't figure out which knight they wanted to move. */
